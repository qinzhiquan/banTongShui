    ...
    <div class="user-detail-group">
      <!--<div class="user-icon">-->
        ...
        <!--&lt;!&ndash;<el-upload&ndash;&gt;-->
          ...
          <!--&lt;!&ndash;:on-change="handleAvatarChange"&ndash;&gt;-->
        <!--&lt;!&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;<img v-if="user_avatar" :src="user_avatar_imgUrl" class="avatar">&ndash;&gt;-->
          <!--&lt;!&ndash;<img v-else src="../images/no_login.jpg" class="avatar">&ndash;&gt;-->
