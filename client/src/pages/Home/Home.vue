<template>
  <div id="home">
    <div id="container">
      <el-row :gutter="20" style="margin: 5vh 0">
        <el-col :span="15" :offset="6"><div class="grid-content bg-purple">
          <el-tag v-for="(cate) in categoryList" :key="cate.cate_id" @click="getRList(cate.cate_id)"
                  style="height:50px;line-height:50px;width: 10vw;background-color: white;text-align: center;font-size: 1.5rem;font-weight: bolder;color: black;">
            {{cate.cate_name}}
          </el-tag>
        </div></el-col>
      </el-row>
      <el-row>
        <!-- 一级菜单 -->
        <el-col :span="2" :offset="1" class="cateList">
          &nbsp;
    ...
    <!-- 尾部 -->
    <div id="footer">
      <img height="90px" src="./img/footer.png" />
