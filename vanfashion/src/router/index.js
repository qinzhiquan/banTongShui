...
const Order = ()=> import('./../pages/Me/Children/Order');//我的订单
...
const AdminUsers = ()=> import('./../pages/Admin/Children/AdminUsers');//用户管理
const Administrator = ()=> import('./../pages/Admin/Children/Administrator');//管理员管理
const AdminOrderCount = ()=> import('./../pages/Admin/Children/AdminOrderCount');//销量统计
...
export default  new VueRouter({
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'AdminOrderCount', component: AdminOrderCount},
