<template>
  <div id="me">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home">时刻腕表</router-link>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <el-menu
              ...
              <el-menu-item index="3"  @click="goTo('/me/order')">
                <i class="el-icon-document-copy"></i>
              ...
              <!--<el-submenu index="3">-->
                ...
                <!--&lt;!&ndash;<el-menu-item-group>&ndash;&gt;-->
                  <!--&lt;!&ndash;<el-menu-item index="3-1" @click="goTo('/me/sales')">待付款</el-menu-item>&ndash;&gt;-->
                  <!--&lt;!&ndash;<el-menu-item index="3-2" @click="goTo('/me/sales')">待发货</el-menu-item>&ndash;&gt;-->
                  <!--&lt;!&ndash;<el-menu-item index="3-3" @click="goTo('/me/sales')">待收货</el-menu-item>&ndash;&gt;-->
                <!--&lt;!&ndash;</el-menu-item-group>&ndash;&gt;-->
              <!--</el-submenu>-->
            </el-menu>
          </div>
